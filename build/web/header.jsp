    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="header-configure-area">
            <div class="language-option">
                <a class="mt-2" href="link address "><i class="bi bi-person-circle text-black-50 pr-2 fs-2"></i></a>
            </div>
            ...
            <ul>
                ...
                <li><a href="./pages.jsp">Pages</a>
                    <ul class="dropdown">
                        ...
                        <li><a href="#">Family sdsdRoom</a></li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <ul class="tn-left">
                            ...
                            <li><i class="fa fa-envelope"></i> DreamStay@fpt.edu.vn</li>
                        </ul>
                    </div>
                    <div class="col-lg-6">
                        <div class="tn-right">
                            ...
                            <a href="#" class="bk-btn">Booking Now</a>
                            <div class="language-option">
                                <a href="login.jsp"><i class="bi bi-person-circle text-black-50">Login</i></a>
                            </div>
                        </div>
                    </div>
                </div>

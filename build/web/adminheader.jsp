<%-- 
    ...
    Created on : Jun 23, 2023, 4:29:28 PM
    Author     : win
--%>
                ...
                <div class="sidebar-wrapper active">
                    <div class="sidebar-header position-relative">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="logo">
                                <a href="index"><img style="width: 150px;height: 50px" src="img/login1234.png" alt="" srcset=""></a>
                            </div>
                    ...
                    <div class="sidebar-menu">
                        <ul class="menu">
                            ...
                            <li
                                class="sidebar-item  ">
                                <a href="getincomeadmin" class='sidebar-link'>
                            ...
                            <li
                                class="sidebar-item ">
                                <a href="listadmin?type=2" class='sidebar-link'>
